...
- **Imported Wine is not required and is not canonical.** Imported Wine may
  exist only as a disabled-by-default, explicit opt-in, lowest-priority
  commercial compatibility option. It is never a prerequisite.

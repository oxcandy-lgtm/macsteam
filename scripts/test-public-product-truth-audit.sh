...
for d in "$GREEN"/*/; do
    name=$(basename "$d")
    # $d from "$GREEN"/*/ carries a trailing slash; strip it so the overlay's
    # ${f#$src/} prefix strip matches and the fixture files land in the tree.
...
# --- §11 matrix E: heading-syntax hardening (Setext, raw HTML, exact titles) ---
run_red "h1-readme-atx-plus-setext-h1" "public_truth_branding_invalid"
run_red "h2-readme-two-setext-product-h1" "public_truth_branding_invalid"
run_red "h3-readme-other-setext-h1-with-macsteam-prose" "public_truth_branding_invalid"
run_red "h4-readme-marker-before-setext-product-h1" "public_truth_marker_missing"
run_red "h5-readme-product-h1-embedded-asterisk" "public_truth_branding_invalid"
run_red "h6-readme-product-h1-unmatched-backtick" "public_truth_branding_invalid"
run_red "h7-readme-product-h1-balanced-emphasis-forbidden" "public_truth_branding_invalid"
run_red "h8-readme-visible-raw-html-h1" "public_truth_branding_invalid"
run_red "h9-canonical-owner-atx-plus-setext-both-complete" "public_truth_docs_drift"
run_red "h10-canonical-owner-two-setext-both-complete" "public_truth_docs_drift"
run_red "h11-canonical-owner-two-different-setext-regex-matches" "public_truth_docs_drift"
run_red "h12-canonical-visible-raw-html-h2-owner" "public_truth_docs_drift"
run_red "h13-readme-visible-raw-html-h2" "public_truth_docs_drift"

# --- §11 matrix E2: shared-lexer closure/boundary hardening (FIX5) ---
# Unclosed HTML comments and backtick/tilde fences fail closed (docs drift),
# both in the README and in every canonical doc.
run_red "h14-readme-unclosed-html-comment" "public_truth_docs_drift"
run_red "h15-readme-unclosed-backtick-fence" "public_truth_docs_drift"
run_red "h16-readme-unclosed-tilde-fence" "public_truth_docs_drift"
run_red "h17-canonical-unclosed-html-comment" "public_truth_docs_drift"
run_red "h18-canonical-unclosed-fence" "public_truth_docs_drift"
run_red "h29-canonical-unclosed-tilde-fence" "public_truth_docs_drift"
# A heading with a CLOSED inline/leading comment stays visible: fragment
# preservation must never hide a real duplicate heading.
run_red "h19-readme-second-h1-inline-closed-comment" "public_truth_branding_invalid"
run_red "h20-readme-second-h1-leading-closed-comment" "public_truth_branding_invalid"
run_red "h21-readme-second-h2-inline-closed-comment" "public_truth_docs_drift"
run_red "h22-readme-second-h2-leading-closed-comment" "public_truth_docs_drift"
run_red "h23-canonical-owner-duplicate-inline-comment" "public_truth_docs_drift"
run_red "h24-canonical-owner-duplicate-leading-comment" "public_truth_docs_drift"
# Tab-indented code (4-column tab stop) is excluded from headings AND
# evidence: a runtime fact / canonical binding hiding there never satisfies.
run_red "h25-readme-runtime-fact-tab-code-only" "public_truth_runtime_invalid"
run_red "h26-canonical-binding-tab-code-only" "public_truth_docs_drift"
run_red "h30-readme-product-h1-indented-code-tab" "public_truth_branding_invalid"
# Fence closure is exact: a shorter marker or trailing text is not a closer.
run_red "h27-readme-shorter-closer-not-closure" "public_truth_docs_drift"
run_red "h28-readme-trailing-text-closer-not-closure" "public_truth_docs_drift"

echo "--- harness mapping self-check ---"
EXPECTED_RED="r1-crossover-prerequisite r2-crossover-canonical r3-no-wine-support r4-system-wine-default r5-managed-wine-available r6-installer-bundled r7-installer-downloaded r8-cloverpit-proven-playable r9-rendered-stable-claim r10-app-bundle-available r11-codesign-notarize-complete r12-release-download-available r13-ready-merge-release-authorized r14-name-reverted-macsteam r15-r5-performed r16-r5-claimed r17-marker-missing r18-marker-duplicate r19-truth-only-in-comment r20-truth-in-unrelated-section r21-roadmap-minimal-complete r22-roadmap-distribution-authorized r23-schema-weakened-app-id r24-manifest-app-id-wrong r25-schema-missing r26-schema-invalid-json r27-authority-missing r28-authority-invalid-json r29-readme-missing r30-readme-current-status-missing r31-readme-runtime-section-duplicate r32-readme-runtime-truth-wrong-section-only r33-readme-roadmap-general-lane-missing r34-readme-roadmap-positive-authorized r35-canonical-doc-missing r36-architecture-positive-binding-removed r37-runtime-contract-positive-binding-removed r38-steam-boundary-positive-binding-removed r39-distribution-boundaries-positive-binding-removed r40-schema-weakened-plus-semantic-false r41-cloverpit-app-id-doc-wrong a1-semantic-branding-display-name a2-semantic-branding-internal-module a3-semantic-platform-os a4-semantic-platform-min-version a5-semantic-platform-arch a6-semantic-runtime-wine-discoverable a7-semantic-runtime-wine-by-default a8-semantic-runtime-managed-available a9-semantic-runtime-crossover-canonical a10-semantic-runtime-crossover-required a11-semantic-runtime-crossover-default a12-semantic-steam-credentials a13-semantic-packaging-app-bundle a14-semantic-packaging-codesigned a15-semantic-packaging-notarized b1-schema-wrong-draft-id b2-schema-root-type-removed b3-schema-section-type-removed b4-schema-scalar-type-removed b5-schema-scalar-type-changed b6-schema-additional-properties-widened b7-schema-required-dropped c1-readme-current-status-fact-removed c2-readme-runtime-fact-moved c3-readme-how-it-works-fence-only c4-readme-distribution-fact-removed c5-readme-safety-comment-only c6-readme-limitations-fact-removed c7-readme-setup-flow-comment-only c8-readme-crossover-disabled-default-removed c9-readme-crossover-optin-removed c10-readme-crossover-lowest-priority-removed c11-readme-crossover-never-prerequisite-removed c12-readme-minimal-lane-mutated c13-readme-general-lane-mutated c14-readme-roadmap-lane-complete-claim c15-readme-roadmap-lane-authorized-claim c16-readme-fake-fenced-l2-heading c17-readme-duplicate-l2-heading c18-readme-r5-moved d1-arch-crossover-disabled-default-removed d2-arch-crossover-optin-removed d3-arch-crossover-lowest-priority-removed d4-arch-crossover-never-prerequisite-removed d5-arch-overview-fence-only d6-arch-overview-unrelated-only d7-steam-credential-removed d8-steam-credential-overview-only d9-steam-credential-comment-only d10-steam-credential-fence-only e1-runtime-generic-bound-imported-wine e2-runtime-generic-bound-system-wine e3-current-status-not-yet-available-other-feature e4-how-it-works-generic-runtime-detection e5-limitations-metadata-removed e6-limitations-save-removed e7-limitations-cloud-removed e8-roadmap-minimal-authorized e9-roadmap-minimal-complete e10-roadmap-general-authorized e11-roadmap-general-complete e12-roadmap-positive-masked-by-negative e13-marker-before-h1 e14-marker-fake-fenced-h1 e15-marker-missing-visible-h1 e16-arch-overview-duplicate-owner f1-owner-first-complete-second-incomplete f2-owner-two-complete-duplicates f3-owner-different-names-both-match f4-owner-fenced-comment-hidden-copy f5-owner-missing-section f6-h1-other-product-prose f7-h1-other-then-macsteam f8-h1-two-macsteam f9-h1-macsteam-plus-other f10-h1-fenced-only f11-h1-comment-only f12-h1-marker-before f13-h1-no-visible-h1 h1-readme-atx-plus-setext-h1 h2-readme-two-setext-product-h1 h3-readme-other-setext-h1-with-macsteam-prose h4-readme-marker-before-setext-product-h1 h5-readme-product-h1-embedded-asterisk h6-readme-product-h1-unmatched-backtick h7-readme-product-h1-balanced-emphasis-forbidden h8-readme-visible-raw-html-h1 h9-canonical-owner-atx-plus-setext-both-complete h10-canonical-owner-two-setext-both-complete h11-canonical-owner-two-different-setext-regex-matches h12-canonical-visible-raw-html-h2-owner h13-readme-visible-raw-html-h2 h14-readme-unclosed-html-comment h15-readme-unclosed-backtick-fence h16-readme-unclosed-tilde-fence h17-canonical-unclosed-html-comment h18-canonical-unclosed-fence h19-readme-second-h1-inline-closed-comment h20-readme-second-h1-leading-closed-comment h21-readme-second-h2-inline-closed-comment h22-readme-second-h2-leading-closed-comment h23-canonical-owner-duplicate-inline-comment h24-canonical-owner-duplicate-leading-comment h25-readme-runtime-fact-tab-code-only h26-canonical-binding-tab-code-only h27-readme-shorter-closer-not-closure h28-readme-trailing-text-closer-not-closure h29-canonical-unclosed-tilde-fence h30-readme-product-h1-indented-code-tab"

...
'
run_audit_navguard "canonical_tokens_present_but_terminal_return_same_side" "canonical tokens present but terminal return same side" 1 "canonicalPrefixEvidenceValid semantics incomplete"

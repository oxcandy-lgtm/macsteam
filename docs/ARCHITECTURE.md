...
MacSteam is a macOS application built with SwiftUI that detects compatible
gaming runtimes (CrossOver, etc.) and launches Windows games via those
runtimes.
